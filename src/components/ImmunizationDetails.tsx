...
const ImmunizationDetails = (props) => {
  ...
  const [immunizationData, setImmunizationData] = useState<{ patientId: string, vaccineName: string; vaccineType: string; dateAdministered: string; lotNumber: string; nextScheduled: string }>({
    vaccineName: '',
    vaccineType: '',
    dateAdministered: '',
    lotNumber: '',
  ...
  const formatDateTime = (date: any) => {
   ...
   return (
    <>
                ...
                >
                  ...
                  >
                    ...
                    <div className="w-full xl:w-3/5">
                        ...
                        <div className={`relative ${immunizationData.vaccineName ? 'bg-light-blue' : ''}`}>
                        <input
                          type="text"
                          name="vaccineName"
                          required
                      ...
                      <div className="w-full xl:w-1/2">
                        ...
                        <div className={`relative ${immunizationData.vaccineType ? 'bg-light-blue' : ''}`}>
                        <input
                           type="text" 
                          name="vaccineType"
                          required
                          value={immunizationData.vaccineType}
                      ...
                      <div className="w-full xl:w-3/5">
                        ...
                        <div className={`relative ${immunizationData.dateAdministered ? 'bg-light-blue' : ''}`}>
                        <input
                            type='date'
                              name="dateAdministered"
                              value={immunizationData.dateAdministered}
                              onChange={handleInputChange}
                              required
                    ...
                    <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                      ...
                      <div className="w-full xl:w-3/5">
                        ...
                        <div className={`relative ${immunizationData.lotNumber ? 'bg-light-blue' : ''}`}>
                        <input
                          type="number"
                          name="lotNumber"
                      ...
                      <div className="w-full xl:w-3/5">
                        ...
                        <div className={`relative ${immunizationData.nextScheduled ? 'bg-light-blue' : ''}`}>
                        <input
                            type='date'
                              name="nextScheduled"
                              value={immunizationData.nextScheduled}
                              onChange={handleInputChange}
                              required
                              placeholder='Reaction'
                              className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-2 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus-border-primary"/>
      ...
      {isCardOpen && (
        <>
            {getImmunization != null && getImmunization?.length > 0 ? (
            <>
            {getImmunization?.map((user, index) => (
                  ...
                  <div className="bg-white p-5 rounded-lg shadow-md">
                    ...
                    <div className="mt-4 flex justify-end">
                      ...
                      <button
                        onClick={() => {
                          hideDeleteConfirmation();
                          deleteImmunizationDetails(user._id);
                        }}
